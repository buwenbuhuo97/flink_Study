 ...
 * Description:map的lambda表达式写法
 */
public class Flink02_Transfrom_Map3 {
    public static void main(String[] args) throws Exception {
        ...
        // TODO 2.核心代码
        // 1.map的lambda表达式写法
        SingleOutputStreamOperator<WaterSensor> map = streamSource.map((MapFunction<String, WaterSensor>) line -> {
