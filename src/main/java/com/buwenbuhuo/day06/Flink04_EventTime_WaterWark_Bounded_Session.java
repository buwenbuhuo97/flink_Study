 ...
 * Description:WaterMark在会话窗口中的使用
 */
public class Flink04_EventTime_WaterWark_Bounded_Session {
    public static void main(String[] args) throws Exception {
        ...
        // 3.开启一个基于事件时间的会话窗口
        WindowedStream<WaterSensor, Tuple, TimeWindow> window = keyedStream.window(EventTimeSessionWindows
                .withGap(Time.seconds(3)));
