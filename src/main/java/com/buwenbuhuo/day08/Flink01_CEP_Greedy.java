 ...
 * Description:CEP模式知识补充:循环模式的贪婪性
 */
public class Flink01_CEP_Greedy {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WaterSensor> waterSensorDStream = env.readTextFile("input/sensor2.txt")
        ...
        /**
         * 非贪婪结果：
         *      {start=[WaterSensor(id=sensor_1, ts=1000, vc=10), WaterSensor(id=sensor_1, ts=2000, vc=20)], end=[WaterSensor(id=sensor_1, ts=3000, vc=30)]}
