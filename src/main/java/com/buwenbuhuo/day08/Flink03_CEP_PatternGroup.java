 ...
 * Description:CEP模式知识补充:循环模式的模式组
 */
public class Flink03_CEP_PatternGroup {
    public static void main(String[] args) throws Exception {
        ...
        /**
         *  未使用模式组结果：
         *      {start=[WaterSensor(id=sensor_1, ts=2000, vc=20)], end=[WaterSensor(id=sensor_2, ts=3000, vc=30)]}
         *      {start=[WaterSensor(id=sensor_1, ts=4000, vc=40)], end=[WaterSensor(id=sensor_2, ts=5000, vc=50)]}
         *  使用模式组结果：
         *      {start=[WaterSensor(id=sensor_1, ts=2000, vc=20), WaterSensor(id=sensor_1, ts=4000, vc=40)], end=[WaterSensor(id=sensor_2, ts=3000, vc=30), WaterSensor(id=sensor_2, ts=5000, vc=50)]}
         */
        // 2.定义模式  模式知识补充(循环模式的模式组)
