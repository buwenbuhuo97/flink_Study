 ...
 * Description:会话窗口（Session Windows）静态会话间隔的代码实现
 */
public class Flink03_TimeWindow_Session {
    public static void main(String[] args) throws Exception {
        ...
        // 3.开启一个基于时间的滑动窗口，会话间隔5s（静态间隔）
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> window = keyedStream.window(ProcessingTimeSessionWindows
