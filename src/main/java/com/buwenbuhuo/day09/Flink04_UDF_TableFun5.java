 ...
 * Description:表函数（Table Functions）：SQL写法
 */
public class Flink04_UDF_TableFun5 {
    public static void main(String[] args) throws Exception {
        ...
        // 5.SQL写法
        tableEnv.executeSql("select id,word from " + table + " join lateral table(myUDTF(id)) on true").print();
